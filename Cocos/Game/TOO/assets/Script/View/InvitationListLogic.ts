...
export default class InvitationListLogic extends Core.ViewLogic {
     ...
     * 被邀请人等级未达要求!
     */
    @Core.code(CodeMap.INVITE_OBTAIN_LEVEL_ERROR, CodeMap.INVITE_REWARD_LIMIT)
    private codeHandle(code) {
        let str = "";
        switch (code) {
            case CodeMap.INVITE_OBTAIN_LEVEL_ERROR:
                str = "被邀请人等级未达要求(7103)";
                break;
            case CodeMap.INVITE_REWARD_LIMIT:
                str = "邀请奖励领取次数已达上限(7104)";
                break;
        }
