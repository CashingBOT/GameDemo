...
export default class DailyTaskItem extends Core.ComponentLogic {
    ...
    public async getBtnCallback() {
        ...
        if (taskRecData) {
            ...
            } else if (taskRecData.rewardType == RewardType.REDBAG) {
            ...
            } else if (taskRecData.rewardType == RewardType.CORONA) {
                rewardObj.type = RewardViewType.DIAL_REWARD;
                rewardObj.msg = taskRecData.balance;
                UserInfoService.turntable = UserInfoService.turntable + taskRecData.balance;
            }
