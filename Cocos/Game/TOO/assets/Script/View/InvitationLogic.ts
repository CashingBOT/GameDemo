...
export default class InvitationLogic extends Core.ViewLogic {
    ...
    /** 需要等级 */
    @property(cc.Label)
    public needLevelL: cc.Label = null;

    /** 描述文字 */
    @property(cc.Label)
    public descL: cc.Label = null;
    ...
    public init(data: { invData: xxgBuf.IInvitationRet; myInvData: xxgBuf.IMyInvitationRet }) {
        ...
        this.needLevelL.string = `好友下载APP\n并达到${this.invData.needLevel}级`;
        if (GameCore.config.isReview) {
            this.descL.string = `1.每成功邀请一位有效玩家，邀请人最高可得20000爱心。\n2.有效玩家：需达到20级。\n3.最终解释权归“摆摊生活”运营平台所有。`;
        } else {
            this.descL.string = `1.每成功邀请一位有效玩家，邀请人最高可得20000爱心。\n2.有效玩家：需成功提现一次且达到${this.invData.needLevel}级。\n3.最终解释权归“摆摊生活”运营平台所有。`;
        }
    }
