...
cc._RF.push(module, '400344kgUBIoZUT4y0QfgX0', 'Game', __filename);
// scripts/Game.js
...
cc.Class({
    ...
    gamePauesResume: function gamePauesResume() {
        if (!this.isPaused) {
            cc.director.pause();
            this.isPaused = true;
            this.node.getChildByName('PauseFont').active = true;
    ...
    gainScoreEnemy1: function gainScoreEnemy1() {
        this.score += 1;
        this.scoreDisplay.string = this.score.toString();
    },
    gainScoreEnemy2: function gainScoreEnemy2() {
        this.score += 9;
        this.scoreDisplay.string = this.score.toString();
    },
    gainScoreEnemy3: function gainScoreEnemy3() {
        this.score += 3;
        this.scoreDisplay.string = this.score.toString();
    },
