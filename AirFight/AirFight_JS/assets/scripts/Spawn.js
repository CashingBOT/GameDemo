...
cc.Class({
    ...
    gameInit() {
        ...
        this.node.runAction(cc.repeatForever(cc.sequence(cc.delayTime(20), cc.callFunc(() => {
            this.spawnNewEnemy2();
        }))))
        ...
        this.node.runAction(cc.repeatForever(cc.sequence(cc.delayTime(40), cc.callFunc(() => {
